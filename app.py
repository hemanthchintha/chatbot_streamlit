...
def format_annotation(text):
    ...
    for index, annotation in enumerate(text.annotations):
        ...
        if file_citation:
            print(f"file_citation attributes: {dir(file_citation)}")
            ...
            if hasattr(file_citation, "quote"):
                ...
                print(f"Warning: 'quote' attribute not found in file_citation object")                
        else:
    ...
    if '[0]' in text_value and not citations:    
...
def load_chat_screen(assistant_id, assistant_title):
    ...
    if user_msg:
        ...
        st.session_state.in_progress = False
        # st.session_state.tool_call = Nonesingle_agent_id
        st.rerun()
...
def main():
    ...
    single_agent_title = os.environ.get("ASSISTANT_TITLE", "Tonbo Assistant")
